...
- A interface e o catálogo funcionam offline; reprodução, atualização e imagens remotas dependem de conexão. A opção “limpar catálogo local” apaga a lista copiada e o histórico, mantendo favoritos. Listas muito grandes (acima de 30 MB) são rejeitadas.
